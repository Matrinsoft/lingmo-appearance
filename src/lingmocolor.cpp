...
#include "lingmo-base/lingmotools.h"
...
[[maybe_unused]] LingmoAccentColor* LingmoColor::createAccentColor(const QColor& primaryColor)
{
    ...
    accentColor->dark(Lingmo::Base::LingmoTools::getInstance()->withOpacity(primaryColor, 0.9));
    accentColor->light(Lingmo::Base::LingmoTools::getInstance()->withOpacity(primaryColor, 0.9));
    accentColor->darker(Lingmo::Base::LingmoTools::getInstance()->withOpacity(accentColor->dark(), 0.8));
    accentColor->lighter(Lingmo::Base::LingmoTools::getInstance()->withOpacity(accentColor->light(), 0.8));
    accentColor->darkest(Lingmo::Base::LingmoTools::getInstance()->withOpacity(accentColor->darker(), 0.7));
    accentColor->lightest(Lingmo::Base::LingmoTools::getInstance()->withOpacity(accentColor->lighter(), 0.7));
    return accentColor;
}
